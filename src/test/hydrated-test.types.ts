...
export namespace NsdTest {
	...
	export type TestProjectResult = CoreTest.TestProjectResult<Config, typeof NSD_EXTENSION_MODULES>
	...
	export type ActParams<T extends CoreTest.BaseXmlTestCase> = CoreTest.ActParams<
		Config,
		T,
		typeof NSD_EXTENSION_MODULES
	>
	export type ActResult = CoreTest.ActResult
	export type TestRunner = CoreTest.TestRunner<Config, typeof NSD_EXTENSION_MODULES>
}
